        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorUsername = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvalidTokens", x => x.TokenId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AudioFile = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artists_FirstName_LastName_CountryId",
                table: "Artists",
                columns: new[] { "FirstName", "LastName", "CountryId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_TrackId_UserId_CreatedAt",
                table: "Comments",
                columns: new[] { "TrackId", "UserId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErrorLogs_ActorUsername",
                table: "ErrorLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvalidTokens_TokenId",
                table: "InvalidTokens",
                column: "TokenId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvalidTokens_UserId_AddedAt",
                table: "InvalidTokens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tracks_Title_ReleaseDate_AlbumId",
                table: "Tracks",
                columns: new[] { "Title", "ReleaseDate", "AlbumId" });
